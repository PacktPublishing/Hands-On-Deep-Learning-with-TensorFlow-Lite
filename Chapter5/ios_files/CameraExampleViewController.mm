...
static NSString* model_file_name = @"cifar_fine_tune_tflite_model";
...
static const int wanted_input_width = 32;
static const int wanted_input_height = 32;
static const int wanted_input_channels = 1;
